...
/* LAYER 3, FN/SHIFT */
[3] = LAYOUT_ortho_4x12(
		KC_AT, KC_EXLM, LALT(KC_2), KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, LSFT(KC_MINS), KC_NO,
		KC_NUHS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, LSA(KC_7), LALT(KC_8), LALT(KC_9), KC_GRV, KC_NO,
	  	KC_TRNS, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, LSA(KC_8), LSA(KC_9), LSFT(KC_GRV), KC_SLSH,
...
[7] = LAYOUT_ortho_4x12(
		KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_7, KC_8, KC_9, KC_SLS,
		KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_4, KC_5, KC_6, KC_AST,
		KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_1, KC_2, KC_3, KC_MNS,
		KC_TRNS, KC_NO, KC_NO, KC_NO, MO(8), KC_NO, KC_NO, KC_NO, KC_0, KC_DOT, KC_EQL, KC_PLS),
